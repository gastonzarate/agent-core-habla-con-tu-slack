...
try:
    role_arn = iam.create_role(RoleName=ROLE, AssumeRolePolicyDocument=json.dumps({
...
print("🌐 API Gateway")
created = api.create_api(Name="slackrag-api", ProtocolType="HTTP",
