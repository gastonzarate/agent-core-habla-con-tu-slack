...
configure = ["agentcore", "configure", "-e", AGENT_PY, "-n", "slackrag", "-rf", REQS,
...
print(f"🔑 Asegurando IAM role {ROLE}...")
ensure_runtime_role()
print("▶️  configure..."); subprocess.run(configure, check=True)
print("▶️  deploy... (1-2 min)"); subprocess.run(deploy, check=True)
